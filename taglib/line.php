...

{
    ...
    private static $basefiled = 'a.id,a.webid,a.aid,a.title,a.selfDriMdd,a.linedate,a.storeprice,a.litpic,a.startcity,a.kindlist,a.attrid,a.bookcount,a.storeprice,a.sellpoint,a.iconlist,a.satisfyscore,a.piclist';
...

    {
        ...
        $suit = ORM::factory('line_suit_price')

            ->where("lineid=:productid and suitid=:tickettypeid order by displayorder asc ")
