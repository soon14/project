...
class Taglib_Dest
{
   ...
   */
    public static function query($params)
    {
        ...
        switch ($flag)
        {
            ...
            case 'order':
                ...
                break;
            case 'gettag':
                $list = self::getdesttag($offset,$row,$destid);
                break;
    ...
    private static  function  getdesttag($offset,$row,$destid){

        $sql = "SELECT * FROM `sline_destinations_tag` where kindid =$destid limit {$offset},{$row}";
