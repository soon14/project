...
<div class="active-pay">
    <h2 style="height: 40px">河北旅游网米淘亲子游业务订单</h2>
    <div class="price-pay"><span></span><?php echo number_format($total_fee,2);?></div>
    <div class="price-txt">收款方<span>河北旅游网米淘亲子游</span></div>
