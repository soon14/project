...

{
...

    {
       ...
       // echo pc端  $platFromClass=Pay_pc;  微信端 $platFromClass=Pay_mobile
...

    {
        ...
        //支付方式  //==fengjishu 07.26 给pay_method 方法传paytype参数

        $view->pay_method = $this->_platFrom->pay_method($paytype);
