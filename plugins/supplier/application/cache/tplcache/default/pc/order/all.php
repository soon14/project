...
" name="starttime" id="starttime" style="width:77px;height:30px;float:left;cursor:pointer;padding-left:3px;background: #2ECC71;color: white;text-align: center"  onclick="calendar.show({ id: this })" />
...
" name="endtime" id="endtime" style="width:77px;height:30px;float:left;cursor:pointer;padding-left:3px;margin:0px 2px;background: #2ECC71;color: white;text-align: center"  onclick="calendar.show({ id: this })" />
                                </div>
...
><?php echo $v;?></option>
                                ...
                                <div class="verify-search-con">
                                    <input type="text" name="searchKey" class="search-txt" style="width: 230px" placeholder="请输入短信码或订单号进行搜索" value="<?php echo $get['searchKey'];?>"/>
                            ...
                            <div class="verify-con">
                                <table class="verify-table" width="100%" border="0">
                                    ...
                                    <tr>
                                        ...
                                        <td><span class="wxf"><?php if($v['paytype']==4) { ?>景区支付<?php } else { ?>在线支付<?php } ?>
</span></td>
                                        <td><span class="price"><?php echo date("Y-m-d",$v['addtime']);?></span></td>
...
" <?php if($v['order_status']=='已过期') { ?>style="color:#999;"<?php } ?>
>
