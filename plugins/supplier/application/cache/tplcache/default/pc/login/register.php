...
<head>
    <meta charset="utf-8">
    <title>注册</title>
    <?php echo Common::css("base.css,login.css");?>
...
<div class="main-reg-box">
    <div class="main-con">
        <div class="reg-box">
            <div class="reg-phone-tit">手机注册</div>
            <div class="reg-phone-step">
                ...
                <div class="current-con" id="setp3_div" style=" display:none">
                    ...
                    <div class="back-btn">
                        <a class="home-btn" href="<?php echo $cmsurl;?>pc">账户首页</a>
                        <a class="now-btn" href="<?php echo $cmsurl;?>pc/qualify/index">马上验证</a>
                    </div>
                </div>
                <!--第三步-->
            </div>
...
<script>
    $(function(){
        ...
        $('.sms-send').click(function () {
            ...
            if (bool === 'true') {
                if ($("#phone").val() != '') {//发送验证码
                    $.post(SITEURL + 'pc/register/ajax_do_phone', {'phone': $('#phone').val()}, function (data) {
                        if (data.status == 1) {
                            if ($("#code").val() != '') {
                                //发送验证码
                            ...
                            $("#phone").parent().find('.error-txt').html('“手机号码”已存在');
        ...
        $('#setp1_form').validate({
            ...
            showErrors: function (errorMap, errorList) {
                ...
                $.post(SITEURL + 'pc/register/ajax_do_setp1', {
                    'phone': $('#phone').val(),
                    'smscode': $('#smscode').val(),
                    'code': $('#code').val(),
                }, function (data) {
