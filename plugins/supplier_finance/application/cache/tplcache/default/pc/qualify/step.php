                                                ...
                                                <div class="zl-con">
                                                    <div class="zj-radio">
                                                        <?php $n=1; if(is_array($kindlist)) { foreach($kindlist as $kind) { ?>
                                                         <label><input type="checkbox" class="apply" name="kindid" value="<?php echo $kind['id'];?>" <?php if(strpos($qd['apply_kind'],$kind['id'])!==false) { ?>checked="checked"<?php } ?>
><?php echo $kind['kindname'];?></label>
                                    ...
                                    <input type="hidden" id="apply_kind" name="apply_kind" value="<?php echo $qd['apply_kind'];?>">
                                </div>
                            </div>
                        </div>
                    </div><!-- 验证步骤 -->
