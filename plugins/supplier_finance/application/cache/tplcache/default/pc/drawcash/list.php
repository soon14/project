                    ...
                    <div class="verify-box">
                        ...
                        <div class="verify-search-box">
                            <div class="verify-search-con" style="float: left">
                                <span class="search-btn1">可提现金额：￥<?php echo $supmoney;?></span>
                            </div>
...
"><?php echo $v['status_name'];?></span>
                                    ...
                                    <td>
                                        <a class="show"
                                           href="<?php echo $cmsurl;?>pc/drawcash/drawcash_detail?id=<?php echo $v['id'];?>">查看详情</a>
                                    </td>
                                </tr>
                                <?php $n++;}unset($n); } ?>
                            </table>
...
<script>
    $(function () {
        ...
        $(".search-btn").click(function () {
            location.href = "<?php echo $cmsurl;?>pc/drawcash/drawcash_apply";
        });
    });
</script>
</body>
