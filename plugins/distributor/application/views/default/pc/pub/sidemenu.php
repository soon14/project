<div class="side-menu">
    <dl class="home">
        <dt><a href="{$cmsurl}pc" id="nav_index">账户首页</a></dt>
    </dl>
    <dl class="account">
        <dt><a href="javascript:;" id="nav_account">账号管理</a></dt>
        <dd>
            <a href="{$cmsurl}pc/index/userinfo" id="nav_userinfo">账户资料</a>
            <a href="{$cmsurl}pc/qualify/index" id="nav_qulification">资质验证</a>
            <a href="{$cmsurl}pc/user/modify_phone" id="nav_modify_phone">修改手机</a>
