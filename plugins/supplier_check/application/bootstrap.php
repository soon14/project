...
Kohana::init(array(
    'base_url' => '/plugins/supplier_check/',
    'index_file' => ''
 ...
 */
//pc版本
Route::set('pc', 'pc(/<controller>(/<action>(/<query>)))', array('query' => '.*'))
    ->defaults(array(
        'action' => 'index',
        'controller' => 'index',
        'directory' => 'pc'
...
//手机版本
Route::set('mobile', 'mobile(/<controller>(/<action>(/<query>)))', array('query' => '.*'))
    ->defaults(array(
        'action' => 'index',
        'controller' => 'index',
        'directory' => 'mobile'
...
$cfg_cmspath = '/plugins/supplier_check';
