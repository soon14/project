{Common::css("mycss/bootstrap.min.css,mycss/base.css")}
<header>
    <!-- 登陆 -->
    <div class="login-box">
        <div class="container">
    ...
    <div class="navbar-collapse">
        <div class="container">
            <ul class="nav nav-pills navbar-nav">
                <li class="active"><a href="{$cmsurl}" class="current">{$GLOBALS['cfg_indexname']}</a></li>
...
{Common::js('jquery.min.js,SuperSlide.min.js')}
<script>
    var SITEURL = "{$cmsurl}";
