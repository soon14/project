...

{
...

    {
...

        {
            ...
            //$where = "mobile='{$loginname}' and mtype=0 ";
...
//        $file  = fopen('fengff.txt','a+');
//
//        $time = date("Y-m-d H:i:s",time());
//
//        fwrite($file,$time.":". var_export($result,true)."\r\n");
//
//        fclose($file);
    ...
    public static function check_member_exist2($loginname)

    {
...

        {
            ...
            $where = "mobile='{$loginname}' and mtype=1 ";

            $re = DB::select()->from('member')->where($where)->execute()->as_array();
        ...
        $arr = array('flag'=>$flag,'userid' =>$re[0]['mid']);
