    ...
    * */
...

    {
     ...
     //   $templet = $templet ? $templet : 'line/self/index';
        ...
        $templet = $templet ? $templet : 'line/self/SelfDriving-newindex';
...
//        Common::cache('set',$this->_cache_key,$content);
...

    {
        ...
        $seoinfo = Model_Nav::get_channel_seo($this->typeid);
        $this->assign('seoinfo', $seoinfo);
        $chooseitem = Model_Line::get_selected_item($route_array,1);

        $searchTitle = Model_Line::gen_seotitle($route_array);

        //  精彩活动

        $huodong  = Model_Line::get_hotAct();
       ...
       // $templet = $templet ? $templet : 'line/self/list-default';
     //   if($admin=='feng'){
            $templet = $templet ? $templet : 'line/self/SelfDriving-list';
//        }else{
//            $templet = $templet ? $templet : 'line/self/list';
//        }
...

    {
       ...
       //================20161221  feng  加入product::get_login_user_info
      ...
      //  $templet = $templet ? $templet : 'line/self/show';
       // if($admin =='feng'){
            $templet = $templet ? $templet : 'line/self/SelfDriving-details';
//        }else{
//            $templet = $templet ? $templet : 'line/self/show';
//        }

       // $templet = $templet ? $templet : 'line/self/show-default';
