...
<div class="ctd-head-box"> 
  ...
  <div class="ck-slide">
    <ul class="ck-slide-wrapper">
      ...
      <li {if $i>0}style="display:none"{/if}><a href="{$src[$i]['adlink']}"><img src="{$src[$i]['adsrc']}" width="100%" height="100%"></a></li>
      <?php endfor?>
  ...
  <section>
    <div class="ctd-ticket-subject">
      <ul>
        ...
        <?php $src  = $data['aditems'];?>
        <?php for($i=0;$i<count($src);$i++):?>
        <li><a href="{$src[$i]['adlink']}"><img src="{$src[$i]['adsrc']}"></a></li>
        <?php endfor?>
        {/st}
        <div class="clearfix"></div>
      </ul>
        ...
        <ul>
          ...
          <li onclick="window.location.href='{$day[url]}'" style="cursor: pointer">
            <div class="J-inner">
              ...
              <div class="J-price">
                <p class="price">{if $day['price']}&yen;<i>{$day['price']}</i>{else}电询{/if}</p>
                <div class="ticket-tit">
                  <h2><a href="javascript:;">{$day['title']}</a></h2>
                  <h3>{if $day['grade']}{$day['grade']}级景区{/if}</h3>
                </div>
              </div>
            </div>
          </li>
        ...
        <ul>
          ...
          <li onclick="window.location.href='{$hot[url]}'" style="cursor: pointer">
            <div class="J-inner">
              ...
              <div class="J-price">
                <p class="price">{if $hot['price']}&yen;<i>{$hot['price']}</i> {else}电询{/if}</p>
                <div class="ticket-tit">
                  <h2><a href="javascript:;">{$hot['title']}</a></h2>
                  <h3>{if $hot['grade']}{$hot['grade']}级景区{/if}</h3>
                </div>
              </div>
            </div>
          </li>
