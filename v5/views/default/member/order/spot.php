...
<head>
    ...
    <title> {if $ordertype=='all'}全部酒店订单{elseif $ordertype=='unpay'}未付款酒店订单{else}未点评酒店订单{/if}-{$webname}</title>
                        ...
                        <div class="order-list">
                            ...
                            <table width="100%" border="0">
                                ...
                                <tr>
                                    ...
                                    <th width="10%" height="38" bgcolor="#fbfbfb" scope="col">支付方式</th>
                                ...
                                <tr>
                                    ...
                                    <td align="center" style="text-align: center"><span class="attr">{if $row['paytype']!=4}在线支付{else}景区支付{/if}</span></td>
                                    <td align="center" style="text-align: center"><span class="attr">{$row['usedate']}</span></td>

                                    <td align="center" style="text-align: center"><span class="attr">{$row['dingnum']}</span></td>
...
<script>
    ...
    $(function(){
        ...
        $(".tabnav span").click(function(){
            ...
            var url = SITEURL+'member/order/spot-'+orderType;
