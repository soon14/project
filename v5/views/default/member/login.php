              ...
              <div class="login-account-key">
                <ul>
                  ...
                  <li class="password"> <span class="tb"></span>
                    <input type="password" class="np-box" name="loginpwd" id="loginpwd" placeholder="请输入登录密码"  onkeyup="onkeys2()"/>
                  </li>
                ...
                <div class="login-account-key">
                  ...
                  <ul>
                    ...
                    <li ><span class="tb"></span>
                      <input type="tel" name="msg" id='msg' class="reg-text w105" placeholder="请输入短信验证码" onkeyup="onkeys()"/>
                      <a class="reg-get-pw sendmsg" id="resend" do-send="true">获取验证码</a>
                    </li>

                    <li class="password" style="display: none">
                      <span class="tb"></span>
                      <input type="password" class="np-box" name="loginpwd" id="loginpwd_2" placeholder="请输入登录密码" onkeyup="onkeys()" />
                    </li>
