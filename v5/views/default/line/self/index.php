...
{/if}
    ...
    <body>
{request "pub/header"}
<div class="banner"><img src="/res/images/myimages/banner1.png" height="360">
 </div>

<div class="container" >
      <div class="main_title text-center">
    <div class="main_more" style="top:5px;"><a href="/lines/self/all"><img src="/res/images/img/more.png"></a></div>
