...
<div class="BreadCrumb Color-fff">
  <ul>
    ...
    <li><a href="/{$dest['pinyin']}/?param=restaurant">饭店<i class="arrow"></i></a><i class="icon-gt">&gt;</i></li>
    {loop $predest $dest}
    <li><a href="/{$dest['pinyin']}/?param=restaurant">{$dest['kindname']}</a></li>
    {/loop}
...
<section>
  <div class="ctd-head-Ticket">
    <div class="container"> 
      <!--门票标头 开始-->
      <div class="ctd-title">
        <h1><em></em>{$info['title']} <span class="J-level">饭店星级：{$info['hotelrank']}</span></h1>
        <div class="J-price">
          ...
          <div class="stage">
            <div class="carousel carousel-stage">
              <ul>
                ...
                <li><img src="{Common::img($pic[0])}" alt="" width="600"> </li>
                {/loop}
    ...
    <div  class="ctd-ticket-booking" id="orderID" >
      <div class="tab-nav">
       ...
       <tbody>
                    ...
                    {st:restaurant action="suit" row="10" productid="$info['id']" return="roomlist"}
