...
Route::set('restaurant', 'restaurant(/<action>_<aid>.html)', array(
...
Route::set('article_list', 'raiders/(<destpy>)(<sign>)(-<attrid>)(-<sorttype>)(-<p>)',
...
Route::set('notes_list', 'notes/(<destpy>)(-<day>)(-<way>)(-<p>)',
...
Route::set('notes_write', 'notes/WRITE',
