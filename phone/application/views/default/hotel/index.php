          ...
          <ul class="am-slides">
            ...
            {st:hotel action="query" flag="order" row="3"}
              {loop $data $row}
                <li>
                    <a href="{$row['url']}">
                    <div class="pic"><img src="/public/images/grey.gif" st-src="{Common::img($row['litpic'],308,195)}" /></div>
                    <div class="rig_txt">
        	...
        	<ul class="st_list_ul">
             {st:hotel action="query" flag="mdd" destid="$row['id']" return="list" row="4"}
                {loop $list $h}
                    <li>
                           <a href="{$h['url']}">
                            <img src="/public/images/grey.gif" st-src="{Common::img($h['litpic'],302,180)}" alt="{$h['title']}" />
