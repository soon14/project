...
<title>河北全攻略</title>
  {Common::css('global_article.css,bootstrap-min.css,public.css,strategy9-1.css,serch_phone_article.css,')}
...
<header class="header">
  <div class="searchBar">
    <div class="searchInt"><input placeholder="输入目的地、景区搜索攻略" class="search_txt" id="sousuo"></div>
    <a class="btn_search" id="searchBtn" href="javascript:;">搜索</a>
  </div>
  <div class="classify" style="margin-top:12px">
    <ul>
...
<section style="margin-top: -12px">
    ...
    <div class="classify-down">
      ...
      <div class="hot-seach1" style="margin-bottom: 40px;">
        <h2>距离</h2>
        <ul class="tabs">
          {loop $attrs[2] $a}
      ...
      <div class="search-but" style="position: fixed;bottom: 0px;left: 25%" ><a  href="javascript:void(0)" title="">确定</a></div>
...
<script type="text/html" id="tpl_article_list">
  ...
  <li class="m-strategy-item">
    <a href="{{value.url}}">
      <div class="item-con">
        <div class="item-img"><img src="{{value.litpic}}" width="100%" alt="{{value.title}}"></div>
        <p class="item-title"><span>{{value.title}}</span></p>
        <p class="item-top">{{if value.gl_mdd}}{{value.gl_mdd}}{{else}}{{value.mdd}}{{/if}}|{{value.dayTour}}</p>
