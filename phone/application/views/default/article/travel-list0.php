    ...
    <div class="search_p">
      <form>
        <div class="search_box">
          ...
          <input id="dest_search_input" class="search_text" placeholder="输入目的地、景区搜索攻略" type="text" value="{$keyword}">
          <a href="javascript:;" style="" class="dest_search_btn"></a> </div>
      </form>
    </div>
  </div>
  <div class="searchNav travel-searchNav">
    <a href="/phone/article/search_2"><i></i>
    <ul class="clearfix">
...
<script type="text/html" id="tpl_article_list">
  ...
  <li  data-url="{{value.url}}"  onclick="toShow(this)">
    <div class="mask"></div>
    <p class="Raid-img"><img src="" laz_src="{{value.newlitpic}}" alt="{{value.title}}" class="img"></p>
  ...
  function get_data()
  {
    ...
    $.getJSON(url,{page:page,destid:destid,sorttype:sorttype,attrid:attrid,keyword:keyword},function(data){
      ...
      if(data==false){
        ...
        $(".ntd-Hebei-Raid img").each(function() {
