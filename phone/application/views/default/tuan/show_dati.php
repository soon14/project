...
<div class="section" id="J_game">
  <div class="game-menu clearfix">
    <div class="game-menu-l">
      <p class="game-hd">共10题，第<span id="J_level_num">1</span>题</p>
...
<div class="section" id="J_game_end">
  <div class="game-res">
    ...
    <div>
      <div class="game-res-share ui-btn" onClick="playagain();">再玩一次</div>
    </div>
    <div>
      <div class="game-res-share ui-btn" onClick="dp_share();">炫耀我的战绩</div>
    </div>
        ...
        var game = {
            ...
            select_ques : function(){
                ...
                if(game_num <= pre_level_num){
                    ...
                    window.location.href='http://www.aitto.net/phone/tuan?usetime='+game_time+'&rightnum='+game.right_num;
                    return false;
                }
                //随机数选问题
