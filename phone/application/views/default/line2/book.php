...
{request "pub/header/typeid/$typeid/isbookpage/1"}
  <section>
      ...
      <div class="book_type">
      	<h3 class="book_tit">自驾日期</h3>
        <div class="people_num">
          <p>
          	<strong>自驾日期：</strong>
            <span>
               <!--input type="text" style="  width: 200px;border: 0;text-align: left" class="startdate" name="startdate" id="startdate" value=""/-->
               <input type="text" style="  width: 200px;border: 0;text-align: left" class="" name="startdate" id="startdate" value=""/>
            </span>
            <!--i>&gt;</i-->
          </p>
      ...
      <div class="book_type">
        ...
        <div class="linkman">
            ...
            <dl>
                <dt></dt>
                <input type="hidden" id="linkman" name="linkman" placeholder="预订联系人姓名" class="" value="" />
                <input type="hidden" id="linktel" name="linktel" class="" placeholder="手机号或固定电话" value="{$member['mobile']}" />
                <input type="hidden" id="linkidcard" name="linkidcard" class="" placeholder="输入18位身份证号码" value="" />
                <dd><strong>订单备注：</strong><textarea name="remark"></textarea></dd>
            </dl>
        </div>
      </div><!--预定人数-->
          ...
          $(".btn_book").click(function(){
              ...
              if(p==false) {
                  if ($validate) {
                      p=true;
                      //===fengjishu 06.07 新加 =========
                      var tourman_1 = $(".tourman").val();
                      var lincard = $(".tourcard").val();
                      $("#linkman").val(tourman_1);
                      $("#linkidcard").val(lincard);
                      //================================
