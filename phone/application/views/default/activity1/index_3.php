...
<div class="gz">
    ...
    <p>*成绩相同，则按时间排序</p>
      ...
      <div class="regular-button"><a href="http://t.cn/RVBQwWb">查看活动详情</a></div>
    </div>
  </div>
   </div>
...
<div class="footer1">
    ...
    <li><a href="javascript:void(0)" onclick="window.location='http://t.cn/RVBHMVM'" class="last-child"><span class="ui-icon ico03"></span><span class="ui-txt">奖品</span></a></li>
  </ul>
        </div>
