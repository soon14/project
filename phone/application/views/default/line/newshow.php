...
<title>{$info['title']}</title>
  ...
  {Common::css('line/mitao_v1_1.css,line/swiper.min.css')}
...
<section>
  ...
  <div class="mt_tags mt10">
    ...
    <div class="ico botl ic_time"><i class="c9">自驾时间：{$info['linedate']} </i></div>
    <div class="ico botl ic_time"><i class="c9">报名截止：{$info['linebefore']} </i></div>
    <div class="ico botl ic_add"><i class="c9">自驾地点：{$info['selfDriMdd']}</i></div>
...
<script>
  ...
  $('.order').click(function(){
              ...
              layer.open({
                  ...
                  title:['选择套餐'],
                  className: 'layui-btn',
                  content: '{st:line action="suit" productid="$info['id']"}'+
                           '{loop $data $r}'+
    ...
    //function choose_day()
    {
        ...
        //var day    ="{$info['linedate1']['endtime1']}";
...
<script >
    ...
    wx.ready(function(){
        wx.onMenuShareTimeline({
            ...
            link: "http://www.aitto.net/phone/lines/show_{$info['aid']}.html", // ''
