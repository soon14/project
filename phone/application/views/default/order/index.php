        ...
        <div class="pho_list">
            ...
            <div class="pho_list_login">
                <div class="pn_code">
                    ...
                    <p><strong>验证码</strong><input type="text" id="code" name="code" class="" placeholder="请输入短信验证码" /><a  id="resend" do-send="true" href="#">获取短信验证码</a></p>
                </div>
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        $('#resend').click(function(){
            ...
            if(bool==='true'){
                //发送验证码
                $.post(SITEURL+'order/ajax_send_message',{'mobile':mobile},function(rs){
                    if(!rs.status){
