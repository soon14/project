...
<section class="mid_content" >
    <form  action="{$cmsurl}mitao/create" id="orderfrm" method="post">
      ...
      <tbody class="people_num">
          ...
          <td width="40%" class="text-center">
            <div class="people_num">
              <a class="sub" href="javascript:;"></a>
                <input type="text" name="childnum" class="order-num" id="childnum" value="1" />
        ...
        <tr id="adult_div" style="display: none">
            ...
            <td class="text-center">
                <div class="people_num">
                    <a class="sub" href="javascript:;"></a>
                    <input type="text" name="dingnum" id="adultnum" class="order-num" value="0" />
                    <a class="add" href="javascript:;"></a>
                </div>
            </td>
        </tr>
  ...
  <div class="mt_order_Contacts" >
    <div class="mt_order_title">联系人信息</div>
      ...
      <div class="form-group username">
        <label>姓名</label>
        <input placeholder="请输入您的真实姓名" type="text" id="linkman" name="linkman">
      </div>
      <div class="form-group password">
        <label>电话</label>
        <input placeholder="请输入您的真实手机" type="phone" id="linktel" name="linktel">
      </div>
  ...
  <p class="chkon">
      <span>我已阅读并同意</span>
      <a style="color:#8ac43e" href="#">合同、取消条款</a>
      <span>等重要条款</span>
  </p>
...
//                    }
    ...
    {
        var url = SITEURL+'mitao/ajax_suit_people';
