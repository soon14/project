...
<header>
    <div class="header_top">
        ...
        <h1 class="tit">注册</h1>
        <a class="top_user_reg" href="/member/login">登录</a>
    </div>
</header>
            ...
            <div class="st_login">
                <form id="form-mobile">
                    ...
                    <div class="number_password">
                        <p><strong>账号：</strong><input type="text" id="phone" name="user" class="" placeholder="请输入手机号"/><a
                                class="yz_num cursor" id="resend" do-send="true">获取验证码</a></p>

                        <p><strong>验证码：</strong><input type="text" name="msg" class="" placeholder="请输入验证码"/></p>
