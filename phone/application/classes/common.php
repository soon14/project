...
//跳转301
    ...
    /*
          该方法 没测试通 2017 0930
     *     原因 关于 配置的回调url 不知该如何配置
     */
    public static function  refund_wxorder($out_trade_no,$total_fee,$refund_fee){


        include_once(VENDORPATH."WxpayAPI_php_v3.0.1/lib/WxPay.Api.php");
        // return VENDORPATH."WxpayAPI_php_v3.0.1/lib/WxPay.Api.php";
        Common::read_log(VENDORPATH."WxpayAPI_php_v3.0.1/lib/WxPay.Api.php");
...

    {
...

        {
            ...
            $dingnum = intval($row['dingnum'])+intval($row['childnum'])+intval($row['oldnum']);
...

            {
                ...
                elseif($typeid==5||$typeid==1||$typeid==106)
