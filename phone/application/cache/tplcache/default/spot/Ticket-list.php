...
<link rel="stylesheet" type="text/css" href="/phone/public/css/ticket/HB_Ticket.css"/>
  ...
  <?php echo Common::js('jquery.min.js,amazeui.js,template.js,ticket/HB_sale_v1_1.js');?>
...
<section class="HB-Ticket-list">
  <div class="HB-class-tab">
    <ul class="clearfix"  data-spy="scrollNav"><i></i>
      <li class="<?php if($pinyin) { ?>active<?php } ?>
" data-url="/phone/spot/search?pinyin=<?php echo $pinyin;?>&themeid=<?php echo $themeid;?>&greatid=<?php echo $greatid;?>"  onclick="toShow(this)"><a href="javascript:void(0)"><?php echo $destnam;?></a></li>
      <li class="<?php if($themeid||$attrId>25||($attrId<20&&$attrId>0)) { ?>active<?php } ?>
" data-url="/phone/spot/search?pinyin=<?php echo $pinyin;?>&themeid=<?php echo $themeid;?>&greatid=<?php echo $greatid;?>"  onclick="toShow(this)"><a href="javascript:void(0)"><?php if($theme!='') { ?><?php echo $theme;?><?php } else { ?><?php if($attrId>25) { ?><?php echo $atr;?><?php } else { ?><?php if($attrId>0&&$attrId<20) { ?><?php echo $atr;?><?php } else { ?>景点主题<?php } ?>
<?php } ?>
<?php } ?>
</a></li>
      <li class="<?php if($greatid||($attrId>19&&$attrId<26)) { ?>active<?php } ?>
"  data-url="/phone/spot/search?pinyin=<?php echo $pinyin;?>&themeid=<?php echo $themeid;?>&greatid=<?php echo $greatid;?>"  onclick="toShow(this)"><a href="javascript:void(0)"><?php if($grea!='') { ?><?php echo $grea;?><?php } else if($attrId>19&&$attrId<26) { ?><?php echo $atr;?><?php } else { ?>景区级别<?php } ?>
</a></li>
    </ul>
  </div>
...
<!--  </div>-->
      ...
      <input type="hidden" id="pinyin" value="<?php echo $pinyin;?>"/>
      <input type="hidden" id="sorttype" value="<?php echo $sorttype;?>"/>
<input type="hidden" id="attrid" value="<?php if($themeid&&$greatid) { ?><?php echo $themeid;?>_<?php echo $greatid;?><?php } else { ?><?php if($greatid) { ?><?php echo $greatid;?><?php } else if($themeid) { ?><?php echo $themeid;?><?php } else if($attrId) { ?><?php echo $attrId;?><?php } ?>
<?php } ?>
"/>
...
<script type="text/javascript">
  ...
  if(localStorage.getItem('dataHtmlticket')){
   ...
   function paixu(th){
     ...
     window.location.href= "/phone/spot/list?pinyin=<?php echo $pinyin;?>&themeid=<?php echo $themeid;?>&greatid=<?php echo $greatid;?>&keyword=<?php echo $keyword;?>&sorttype="+sorttype
   }
    function toShow(th){
...
<?php echo Common::js('mitao/mitao_v1_1.js');?>