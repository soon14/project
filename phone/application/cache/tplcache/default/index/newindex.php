...
<?php echo Common::css('index/HB_HotSale.css');?>
<?php echo Common::css('mitao/swiper.min.css');?>
<?php echo Common::js('index/jquery-1.11.3.min.js');?>
<?php echo Common::js('jquery.min.js,amazeui.js,template.js');?>
<?php echo Common::js('mitao/swiper.min.js');?>
...
<div class="HB_banner">
  ...
  <div class="swiper-container swiper-container-horizontal">
    <div class="swiper-wrapper">
      <?php require_once ("/home/wwwroot/www.aitto.net/phone/taglib/ad.php");$ad_tag = new Taglib_Ad();if (method_exists($ad_tag, 'getad')) {$data = $ad_tag->getad(array('action'=>'getad','name'=>'s_index_1',));}?>
      <?php $n=1; if(is_array($data['aditems'])) { foreach($data['aditems'] as $v) { ?>
      <div class="swiper-slide" data-url="<?php echo $v['adlink'];?>"  onclick="toShow(this)"><img src="<?php echo Common::img($v['adsrc']);?>" title="<?php echo $v['adname'];?>"></div>
      <?php $n++;}unset($n); } ?>
...
<div class="no-content" id="no-content" style="text-align: center; display:none; ">
  <img src="<?php echo $GLOBALS['cfg_public_url'];?>images/nocon.png" width="80%"/>
  <p>啊哦，暂时没有相关信息</p>
</div>
<div id ="allmap"></div>
