...
Game9G.prototype.init = function() {
	...
	this.homeurl = "http://mp.weixin.qq.com/s?__biz=MzA3NTM3NTc0MQ==&mid=214135147&idx=1&sn=ae695d9ebc8fd0c3ac2b8dee9f7bb7ea#rd";
	this.gzurl = "http://www.txl.site/games/";
	this.shareDomain = this.shareDomains[parseInt(Math.random() * this.shareDomains.length)];
	this.shareData.imgurl = "http://www.txl.site/games/fkcsg/icon.png";
	this.shareData.link = "http://www.txl.site/games/fkcsg/";
