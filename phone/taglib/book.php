...
<section>
  <div class="container-fluid order-box">
    ...
    <div class="order-item">
      ...
      <dl>
        <dt>价格</dt>
        <dd>
          <div class="reply-price"><i>¥</i><dfn id="price_item_1">{$info['price']}</dfn></div>
        </dd>
      </dl>
      <div class="cl"></div>
    </div>
  ...
  <div class="container-fluid order-box">
    ...
    <div class="order-item">
      <dl>
        <dt>姓名</dt>
        <dd>
          <input name="user" type="text" class="deply-input" id="user"  placeholder="填写您的姓名">
        </dd>
      </dl>
      <dl>
        <dt>手机号</dt>
        <dd>
          <input name="userPhone" type="text"  class="deply-input" id="userPhone"  placeholder="填写您的手机号" >
        </dd>
      </dl>
      <div class="cl"></div>
    </div>
  ...
  <div class="container-fluid agree-box">
    <input name="" id = "agree" type="checkbox" value="" >
