...
$(document).ready(function() {
    $(".drop-trigger").mouseover(function() {
        $(this).addClass("hover");
        $(this).children(".dropdown").show()
    });
    $(".drop-trigger").mouseout(function() {
...
$(document).ready(function() {
    //导航下三角	 
    var tag_select = "<span class='down-arrow'></span>";
    $(".J-con-nav .current").append(tag_select);
    ...
    function activeTabs() {
        ...
        $(this).append(tag_select).siblings().children().remove(".down-arrow");
    ...
    // 导航切换 函数调用
    // ===============		
    $(document).on('click', '[data-toggle="tabs"] > li', activeTabs);
...
$(document).ready(function() {
    ...
    $(document).on("click", ".top-category span.crumb-select-item",
    function(event) {
    ...
    //    $(".show-con li").removeClass("current");
    //});
...
$(document).ready(function() {
    ...
    function ToolbarScroll() {
        ...
        DocumentHeight = DocumentHeight - WindowHeight - 200;
        if (ScrollTopHeight > WindowHeight) {
            if (ScrollTopHeight < DocumentHeight) {
                $('.toolbar-item-top').show();
                $('.mfw-toolbar').removeClass('toolbar-item-b').addClass("toolbar-item-a");
            } else {
                $('.toolbar-item-top').show();
                $('.mfw-toolbar').addClass("toolbar-item-b").removeClass('toolbar-item-a');
            }
        } else {
            $('.toolbar-item-top').hide().removeClass("toolbar-item-bottom");
        }
    }

    $('._j_code').hover(function() {
...
function(t) {
    ...
    t.jCarousel.plugin("jcarouselPagination", {
        ...
        _reload: function() {
            ...
            else for (var s, e = parseInt(i, 10) || 0, r = this.carousel().jcarousel("items"), n = 1, o = 0;;) {
