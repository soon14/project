...
CREATE TABLE `sline_article` (
  ...
  `gl_mdd` varchar(50) NOT NULL COMMENT '目的地點',
  ...
  `likeNum` int(9) NOT NULL DEFAULT '83' COMMENT '喜欢点一下',
  PRIMARY KEY (`id`),
...
) ENGINE=InnoDB AUTO_INCREMENT=58 DEFAULT CHARSET=utf8 COMMENT='文章/攻略表';-- <xjx> --
