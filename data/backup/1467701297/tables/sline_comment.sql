...
CREATE TABLE `sline_comment` (
  ...
  `floorid` int(11) NOT NULL DEFAULT '0' COMMENT '楼层id',
  `openid` varchar(50) NOT NULL COMMENT '用户的openid',
...
) ENGINE=InnoDB AUTO_INCREMENT=194 DEFAULT CHARSET=utf8 COMMENT='评论表';-- <xjx> --
