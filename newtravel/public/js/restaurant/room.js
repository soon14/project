...
//store
    window.product_store = Ext.create('Ext.data.Store', {
        ...
        proxy: {
            type: 'ajax',
            api: {
                read: SITEURL + 'restaurant/room/action/read/hotelid/' + hotelid,  //读取数据的URL
                update: SITEURL + 'restaurant/room/action/save/hotelid/' + hotelid,
                destroy: SITEURL + 'restaurant/room/action/delete/hotelid/' + hotelid
            },
            reader: {
                type: 'json',   //获取数据的格式
                root: 'lists',
...
function updateField(ele, id, field, value, type) {
    ...
    Ext.Ajax.request({
        url: SITEURL+"restaurant/room/action/update",
        method: "POST",
        datatype: "JSON",
...
function delChoose()
{
   ...
   /* Ext.Msg.confirm("提示","确定删除",function(buttonId){
    ...
    ST.Util.confirmBox('删除套餐','确定删除吗?',function(){
...
{
    var hotelid = $("#hotelid").val();
    var url = SITEURL+'restaurant/room_op/parentkey/product/itemid/2/action/add/hotelid/'+hotelid;
    ST.Util.addTab('添加套餐',url);
}
//修改套餐
