...
class Controller_Attrid extends Stourweb_Controller{
     public static $table_arr=array(
         ...
         13=>'tuan_attr',
      //   102=>'farm_attr'
         102=>'specialty_attr',// 特产
         103=>'restaurant_attr',//  饭店
         104=>'smallprogram_question_attr',//  题库分类
         106=>'mitao_attr',//  米淘
         107=>'act_attr',//
     );
    public static $extend_table_arr=array(
        ...
        102=>'sline_specialty_extend_field',
        103=>'sline_restaurant_extend_field',
        106=>'sline_mitao_extend_field',
        107=>'sline_act_extend_field'
    );
    ...
    public static $content_table=array(
        ...
        13=>'tuan_content',
       // 102=>'farm_content'
        102=>'specialty_content',
        103=>'restaurant_content',
        106=>'mitao_content',
        107=>'act_content'
    );
    public function before()
    {
        ...
        if($type_id<14||$type_id==102||$type_id==103) //通知模块暂时不设置权限
        {
            if($action == 'list')
            {
