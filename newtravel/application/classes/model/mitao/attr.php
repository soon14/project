...
class Model_Mitao_Attr extends ORM {

    protected  $_table_name = 'mitao_attr';
    ...
    public function deleteClear()
    {
        ...
        $children=ORM::factory('mitao_attr')->where("pid={$this->id}")->find_all()->as_array();
