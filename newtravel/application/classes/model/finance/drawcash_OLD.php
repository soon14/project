...

    {
...

        {
            ...
            if ($item['applyusertype'] == "supplier")
                ...
                $list[$i]["applyusertype_name"] = "供应商123";
...
sql;
    ...
    public function auditing_drawcash_apply($applyusertype, $applyid, $status, $audit_description ,$time=null)
...
sql;
            ...
            //======================fengjishu  start
            if($status=='1') {
                $where = " addtime<$time and isconsume=1 and is_drawcash = 0 and paytype !=3 and status = 5 and find_in_set('$applyid',supplierlist) ";
