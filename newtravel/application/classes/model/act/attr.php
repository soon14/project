...
class Model_Act_Attr extends ORM {

    protected  $_table_name = 'act_attr';
    ...
    public function deleteClear()
    {
        ...
        $children=ORM::factory('act_attr')->where("pid={$this->id}")->find_all()->as_array();
