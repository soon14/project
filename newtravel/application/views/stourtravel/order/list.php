            ...
            <div class="search-bar filter" id="search_bar">
                ...
                <div class="change-btn-list mt-4 ml-10">
                    ...
                    <select name="supplier" onchange="togSupplier(this)" class="bar-select">
                        ...
                        <option name='suppliername' value="{$v['id']}" {if $v['id']==$supid}selected=selected{/if}>{$v['suppliername']}</option>
                ...
                <div class="change-btn-list mt-4 ml-10">
                    ...
                    <select name="distributor" onchange="togDistributor(this)" class="bar-select">
                        ...
                        <option name='distributorname' value="{$v['id']}" {if $v['id']==$dispid}selected=selected{/if}>{$v['distributorname']}</option>
                ...
                <div class="pro-search ml-10 mt-4 fl mt-4">
                    {if $typeid ==1}
                      {if $keyword}
                      <input type="text" id="searchkey" value="{$keyword}" placeholder="订单号/产品名称/联系人" datadef="订单号/产品名称/联系人" class="sty-txt1 set-text-xh wid_200"  onkeydown="entersearch()"/>
                      {else}
...
<input type="hidden" value="{$Special_key}" id ="skey">
</table>
        ...
        window.product_store = Ext.create('Ext.data.Store', {
            ...
            proxy: {
                ...
                api: {
                    ...
                    read: SITEURL+'order/index/action/read/typeid/{$typeid}?supplier_id={$supid}',  //读取数据的URL
...
function updateField(ele, id, field, value, type,wxuserid) {
    ...
    var typeid = "{$typeid}"; // 11.23封  加入 用于 线路取消订单 时候 操作 微信用户表
