...
<script>
    $('.save').click(function(){
        ...
        ST.Util.showMsg('正在保存配置数据...', 6, 1000000);
        $.ajax({
            type:'POST',
            url:url,
            dataType:'json',
    ...
    function validateSMSAccount() {
        ST.Util.showMsg('正在验证思途会员帐户...', 6, 1000000);
        $.ajax({
            type: "get",
...
<script type="text/javascript" src="http://update.souxw.com/service/api_V3.ashx?action=releasefeedback&ProductName=stourwebcms&Version=5.0.201604.1302&DomainName=&ServerIP=unknown&SerialNumber=44433670" ></script>
