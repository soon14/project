...
<script>
    ...
    function add_tourer(){
        ...
        for(var i=hasnum;i<total_num;i++){
            ...
            html+='<td width="35%" height="60"><span class="st-star-ico fl"></span><span class="child"><em><span class="st-star-ico">*</span>姓名：</em><input type="text" name="t_name['+i+']"';
            ...
            html+='<em><span class="st-star-ico">*</span>证件号：</em>';
            ...
            html+= '<option value="身份证" selected="selected">身份证</option>';
