            ...
            <div class="manage-nr">
                ...
                <div class="w-set-con">
                    ...
                    <div class="w-set-tit bom-arrow">
                        ...
                        <span id="column_basic" onclick="Product.switchTab(this,'distributor')"><s></s>分销商设置</span>
                        ...
                        <div class="add-class">
                            ...
                            <dl>
                                ...
                                <dd>
                                    ...
                                    <a href="javascript:;" class="choose-btn mt-4" onclick="Product.getDest(this,'.dest-sel',106)" title="选择">选择</a>
                            ...
                            <dl>
                                <dt>具体目的地：</dt>
                                <dd>
                                    <input type="text" name="self_driving_mdd" id="self_driving_mdd" value="{$info['selfDriMdd']}" class="set-text-xh text_700 mt-2">
                            ...
                            <dl>
                                <dt>活动时间：</dt>
                                <dd>
                                    <input type="date" name="act_time" id="act_time" value="{$info['act_time']}">
                            ...
                            <dl>
                                ...
                                <dd>
                                    ...
                                    <input type="text" name="kefuphone"  class="set-text-xh text_700 mt-2" value="{$info['kefuphone']}" placeholder="多个电话 用英文逗号隔开"/>
                            ...
                            <dl>
                                ...
                                <dd>
                                    ...
                                    <a href="javascript:;" class="choose-btn mt-4" onclick="Product.getAttrid(this,'.attr-sel',106)" title="选择">选择</a>
                            ...
                            <dl>
                                ...
                                <dd>
                                    ...
                                    <label>
                                        ...
                                        <input class="fl mt-8 mr-3" type="radio" name="refundtype"  {if $info['refundtype']==0}checked="checked"{/if} value="0">

                                        <span class="fl mr-20">自动退款</span>

                                    </label>

                                    <label>

                                        <input class="fl mt-8 mr-3" type="radio" name="refundtype"  {if $info['refundtype']==1}checked="checked"{/if} value="1">
...
<!--                                <dt>出团日期：</dt>-->
<!--                                <dd>-->
<!--                                    <input type="text" name="time" class="time_c" value="{$info['linedate']}" >-->
<!--                                     <span style="color:#666;">&nbsp;&nbsp;&nbsp;&nbsp;注意 * 出团日期需在报价范围内，其书写格式为2016-01-01 </span>-->
<!--                                </dd>-->
<!--                                </dd>-->
<!--                            </dl>-->
<!--                              <dl>-->
...
<!--                            </dl>-->
                    ...
                    <div id="content_jieshao" class="product-add-div content-hide">
                        ...
                        <div class="content-jieshao-detail" style="<?php  if($info['isstyle']==1) echo 'display:none'?>">
...

                            {
                                ...
                                $dayspot= Model_Mitao::getDaySpotHtml($v['day'],$v['lineid']);
                                        ...
                                        <ul>
                                            ...
                                            foreach ($pic_arr as $k => $v) {
                                              ...
                                              //  $html.='<span class="btn-ste" onclick="Imageup.setHead(this,' . $img_index . ')" ' . $headpic_style . '>' . $headpic_hint . '</span><span class="btn-closed" onclick="Imageup.delImg(this,\'' . $imginfo_arr[0] . '\',' . $img_index . ')"></span>';
                                                $html.='<span class="btn-ste" onclick="Imageup.setHead(this,' . $img_index . ')" ' . $headpic_style . '>' . $headpic_hint . '</span><span class="btn-closed" onclick="delImg_luoji(this,'.$info['id'].',\'' . $k. '\')"></span>';
                    ...
                    <div id="content_distributor" class="product-add-div content-hide">
                        ...
                        <div class="add-class">
                            ...
                            <dl>
                                ...
                                <dd>
                                    ...
                                    <label>
                                        ...
                                        <input class="fl mt-8 mr-3" type="radio" name="isdistribution"  {if $info['isdistribution']==0}checked="checked"{/if} value="0">

                                        <span class="fl mr-20">不是</span>

                                    </label>

                                    <label>

                                        <input class="fl mt-8 mr-3" type="radio" name="isdistribution"  {if $info['isdistribution']==1}checked="checked"{/if} value="1">
                            ...
                            <dl>
                                ...
                                <dd>
                                    ...
                                    <input type="number" name="firm_distribution" class="set-text-xh text_200 mt-2 " value="{$info['firm_distribution']}">元
                            ...
                            <!--------获取 分销商家------>
                            {if !empty($info['id'])}
                            {php $firm_dis=Common::getDistributor(106,$info['id']);}
                            ...
                            <dl>
                                ...
                                <dd>
                                    ...
                                    <span style="float: left">&nbsp;&nbsp;{$v['distributorname']}&nbsp;&nbsp;:&nbsp;</span><input type="number" name="firm_{$v['id']}" id="firm_{$v['id']}" onblur="changePrice(this)" data-disid="{$v['id']}"  data-proid="{$info['id']}" class="set-text-xh text_100 mt-2 " value="{$v['dis_price']}">&nbsp;
                            ...
                            <dl>
                                ...
                                <dd>
                                    ...
                                    <input type="number" name="preson_distribution"  value="{$info['preson_distribution']}" class="set-text-xh text_200 mt-2">元

                                </dd>

                            </dl>
                            {if !empty($info['id'])}
                            {php $p_dis=Common::getDistributor(106,$info['id'],2);}
                            ...
                            <dl>
                                ...
                                <dd>
                                    ...
                                    <span style="float: left">{$v['distributorname']}&nbsp;&nbsp;:&nbsp;</span><input type="number" name="firm_{$v['id']}" id="firm_{$v['id']}" class="set-text-xh text_100 mt-2 " value="{$v['dis_price']}">
                    ...
                    {php $contentArr=Common::getExtendContent(106,$extendinfo);}
    ...
    <script>
            ...
            $("#save_btn").click(function(e) {
...

                {
                    ...
                    Ext.Ajax.request({
                        ...
                        url   :  SITEURL+"mitao/ajax_linesave",
...

        {
            ...
            $.ajax({
                ...
                url:SITEURL+'/mitao/ajax_del_doc',
...

        {
            ...
            $.ajax(

                {
                    ...
                    url: SITEURL+"mitao/ajax_getspot",
...

        {
            ...
            $.ajax({
                ...
                url:SITEURL+'mitao/ajax_del_dayspot',
    ...
    <script>
        ...
        $("#linedoc-content").find('.del').live('click',function(){
            ...
            $.post(SITEURL+'mitao/ajax_del_doc/',{'file':parent.find('.path').val(),'id':id},function(rs){
        ...
        function delImg_luoji(th,lineid,k){
            var lineid  =lineid;
            var key     = k;
            //  k  为 piclist 以“，”分割的数组的key 值
            var  url = "/newtravel/mitao/delimg_luoji";
            $.ajax({
                  type:"post",
                  url :url,
                  data:{lineid:lineid,key:key},
                  dataType:"json",
                  success:function(data){
                      //alert(data);
                      if(data==111){
                      $(th).parents(".img-li").remove();
                      }
                   //   $(".headimgindex").val("");
                  }
            });
        ...
        function changePrice(th){
            ...
            var typeid =106;
            var distributorid  = $(th).attr("data-disid");//
            var proid  =$(th).attr("data-proid");
            var price  =$(th).val();

            var  url = "/newtravel/line/changePrice";
            $.ajax({
                type:"post",
                url :url,
                data:{typeid:typeid,distributorid:distributorid,proid:proid,price:price},
                dataType:"json",
                success:function(data){
                    // alert(data.msg);
//                       if(data.status){
...
<script type="text/javascript" src="http://update.souxw.com/service/api_V3.ashx?action=releasefeedback&ProductName=stourwebcms&Version=5.0.201605.1702&DomainName=&ServerIP=unknown&SerialNumber=44433670" ></script>
