...
<title>签证添加/修改</title>
    ...
    <style>
        #attachment-content{  margin-left: 50px; line-height: 30px; list-style: none; clear: both;}
          ...
          <div class="manage-nr">
              ...
              <!--/基础信息结束-->
                  ...
                  <div class="product-add-div" data-id="material">
                      ...
                      <div id="material-1">{php Common::getEditor('material',$info['material'],$sysconfig['cfg_admin_htmleditor_width'],600);}</div>
                      <div id="material-2" style="display: none">{php Common::getEditor('material2',$info['material2'],$sysconfig['cfg_admin_htmleditor_width'],600);}</div>
                      <div id="material-3" style="display: none">{php Common::getEditor('material3',$info['material3'],$sysconfig['cfg_admin_htmleditor_width'],600);}</div>
                      <div id="material-4" style="display: none">{php Common::getEditor('material4',$info['material4'],$sysconfig['cfg_admin_htmleditor_width'],600);}</div>
                      <div id="material-5" style="display: none">{php Common::getEditor('material5',$info['material5'],$sysconfig['cfg_admin_htmleditor_width'],600);}</div>

                  </div>
                  <div class="product-add-div" data-id="booknotice">
                      {php Common::getEditor('booknotice',$info['booknotice'],$sysconfig['cfg_admin_htmleditor_width'],200);}
                  </div>
                  <div class="product-add-div" data-id="circuit">
                      {php Common::getEditor('circuit',$info['circuit'],$sysconfig['cfg_admin_htmleditor_width'],200);}
                  </div>
                  <div class="product-add-div" data-id="friendtip">
                   {php Common::getEditor('friendtip',$info['friendtip'],$sysconfig['cfg_admin_htmleditor_width'],200);}
                  </div>
                  <div class="product-add-div" data-id="attachment">
                      <div id="doclist" class="up-pic">
                          <dl>
                              <dt>签证附件：</dt>
                              <dd>
                                  <div class="up-file-div">
	...
	$(document).ready(function(){
        ...
        //如果是修改页面
            ...
            $("#attachment-content").find('.del').live('click',function(){
                ...
                $.post(SITEURL+'visa/ajax_del_doc/',{'file':parent.find('.path').val(),'id':id},function(rs){
                    if(rs.status){
                        parent.remove();
                    }
                },'json');
