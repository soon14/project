    ...
    function () {
        ...
        window.attr_store = Ext.create('Ext.data.TreeStore', {
            ...
            proxy: {
                type: 'ajax',
                api: {
                    read: SITEURL + 'Acomment/index/action/read/',  //读取数据的URL
                    update: SITEURL + 'Acomment/index/action/save/',
                    destroy: SITEURL + 'Acomment/index/action/delete/'
                },
                reader: 'json'
            },
            autoLoad: false,
        ...
        window.attr_treepanel = Ext.create('Ext.tree.Panel', {
            ...
            columns: [
                ...
                {
                    text: '<span class="grid_column_text">头像</span>',
                ...
                },
                {
                    ...
                    text: '<span class="grid_column_text">评论内容</span>' ,
                    dataIndex: 'content',
                    id: 'attr_name',
                    sortable: false,
                    locked: false,
                ...
                {
                    text: '<span class="grid_column_text">评论人</span>',
                    dataIndex: 'nickname',
                    width: '10%',
                    draggable: false,
                    menuDisabled:true,
                ...
                {
                    text: '<span class="grid_column_text">评论时间</span>',
                    dataIndex: 'addtime',
                    width: '16%',
                    align: 'left',
                    border: 0,
                    ...
                    renderer: function (value, metadata, record) {
                        ...
                        value=!value?'':value;
                        return "<input type='text' class='row-edit-txt' style='text-align:left' onclick=\"ST.Util.prevPopup(event,this)\"  value='" + value + "'/>";
                    ...
                    items: [
                        {
                            ...
                            handler: function (view, index, colindex, itm, e, record) {
                                ...
                                updateField(null, id, 'isshow', newval);
...
function addSub(pid) {
    ...
    Ext.Ajax.request({
        method: 'post',
        url: SITEURL + 'Acomment/index/action/addsub/',
        params: {pid: pid},
        success: function (response) {
...
function updateField(ele, id, field, value, type) {
    ...
    Ext.Ajax.request({
        url: SITEURL + "Acomment/index/action/update/",
        method: "POST",
        datatype: "JSON",
