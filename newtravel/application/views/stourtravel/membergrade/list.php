...
Ext.onReady(
    function () {
        ...
        $("#addbtn").click(function () {
            ...
            var url = SITEURL + "membergrade/add/parentkey/{$parentkey}/itemid/{$itemid}/ismobile/"+ismobile;
...
function modify(id) {
    ...
    var ismobile = "{$ismobile}";
    var url = SITEURL + 'membergrade/edit/parentkey/{$parentkey}/itemid/{$itemid}/id/' + id+'/ismobile/'+ismobile;
...
<script type="text/javascript" src="http://update.souxw.com/service/api_V3.ashx?action=releasefeedback&ProductName=stourwebcms&Version=5.0.201604.1502&DomainName=&ServerIP=unknown&SerialNumber=44433670" ></script>
