    ...
    function() 
    {
        ...
        //添加按钮
         $("#addbtn").click(function(){
            ...
            ST.Util.addTab('添加帮助','{$cmsurl}help/add/parentkey/article/itemid/7',1);
        });
...
<script type="text/javascript" src="http://update.souxw.com/service/api_V3.ashx?action=releasefeedback&ProductName=stourwebcms&Version=5.0.201604.1101&DomainName=&ServerIP=unknown&SerialNumber=44433670" ></script>
