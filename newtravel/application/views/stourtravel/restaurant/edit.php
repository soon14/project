     ...
     <td valign="top" class="content-rt-td">
          ...
          <div class="manage-nr">
                  ...
                  <div class="product-add-div">
                      ...
                      <div class="add-class">
                          ...
                          <dl>
                              <dt>饭店属性：</dt>
                              <dd>
                                  <a href="javascript:;" class="choose-btn mt-4" onclick="Product.getAttrid(this,'.attr-sel',103)" title="选择">选择</a>
                                  <div class="save-value-div mt-2 ml-10 attr-sel">
                                      <?php //var_dump($info['attrlist_arr'])?>
              ...
              <!--/基础信息结束-->
                  ...
                  {php $contentArr=Common::getExtendContent(103,$extendinfo);}
        ...
        $("#btn_save").click(function(){
            ...
            //验证酒店名称
             if(hotelname==''){
                   $("#nav").find('span').first().trigger('click');
                   $("#hotelname").focus();
                   ST.Util.showMsg('请填写饭店名称',5,2000);
               }
               else
               {
                   Ext.Ajax.request({
                       url   :  SITEURL+"restaurant/ajax_save",
                       method  :  "POST",
                       isUpload :  true,
                       form  : "product_frm",
                       waitMsg  :  "保存中...",
