        ...
        <td valign="top" class="content-rt-td">
                    <div class="w-set-con">
                        <div class="w-set-tit bom-arrow">
                            {template 'stourtravel/restaurant/kind_top'}
...
<script>
    ...
    function getRankList()
    {
        ...
        $.getJSON(SITEURL+"restaurant/ajax_ranklist","webid="+webid,function(data){
    ...
    {
        var webid=0;
        var ajaxurl = SITEURL+'restaurant/ajax_rank_save';
    ...
    function del(id,obj)
    {
        ST.Util.confirmBox('删除星级','确定删除吗?',function(){
            ...
            {
                var boxurl = SITEURL+'restaurant/ajax_rank_del';
...
<script type="text/javascript" src="http://update.souxw.com/service/api_V3.ashx?action=releasefeedback&ProductName=stourwebcms&Version=5.0.201603.2404&DomainName=&ServerIP=unknown&SerialNumber=44433670" ></script>
