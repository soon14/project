...
<script>
	...
	$(document).ready(function(){
        ...
        $("#btn_save").click(function(){
                ...
                if(roomname==''){
                   ...
                   Ext.Ajax.request({
                       url   :  SITEURL+"restaurant/ajax_room_save",
                       method  :  "POST",
                       isUpload :  true,
                       form  : "product_frm",
    ...
    function showMore()
    {
       ...
       // var url = "calendar.php?suitid="+suitid+"&carid="+carid;
        var url = SITEURL+'calendar/index/suitid/'+suitid+'/typeid/103/productid/'+productid;
