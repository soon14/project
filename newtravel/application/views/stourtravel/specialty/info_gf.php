    ...
    function () {
        ...
        window.attr_store = Ext.create('Ext.data.TreeStore', {
            ...
            proxy: {
                ...
                api: {
                    read: SITEURL+'specialty/infoset/action/read/articleid/{$articleid}',  //读取数据的URL
                    update:  SITEURL+'specialty/infoset/action/save/articleid/{$articleid}',
                    destroy:  SITEURL+'specialty/infoset/action/delete/articleid/{$articleid}'
                },
                reader: 'json'
            },
            autoLoad: true,
