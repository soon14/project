     ...
     <td valign="top" class="content-rt-td ">
          ...
          <div class="manage-nr">
              <div class="w-set-tit bom-arrow" id="nav">
                  ...
                  <span data-id="tupian"><s></s>特产附件</span>
...
<!--                          </dl>-->
              ...
              <div class="product-add-div" data-id="extend">
                      ...
                      {php Common::genExtendData(102,$extendinfo);}
                  </div>
...
//============================================================fengjingchun
	...
	$(document).ready(function(){
        ...
        $("#btn_save").click(function(){
            ...
            //验证名称
             if(articlename==''){
               ...
               {
                   Ext.Ajax.request({
                       url   :  SITEURL+"specialty/ajax_save",
                       method  :  "POST",
                       isUpload :  true,
                       form  : "product_frm",
                       datatype  :  "JSON",
        ...
        $("#btn_saves").click(function(){
            ...
            {
                Ext.Ajax.request({
                    url   :  SITEURL+"specialty/ajax_saves",
                    method  :  "POST",
                    isUpload :  true,
                    form  : "product_frm",
                   // datatype  :  "JSON",
     ...
     function delAttach()
     {
                ...
                $.ajax({
                    type:'POST',
                    url:SITEURL+'/specialty/ajax_del_attach',
