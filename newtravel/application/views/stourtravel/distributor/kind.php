...
<script>
        ...
        function () {
            ...
            window.attr_store = Ext.create('Ext.data.TreeStore', {
                ...
                proxy: {
                    ...
                    api: {
                        read: SITEURL+'distributor/kind/action/read',  //读取数据的URL
                        update:  SITEURL+'distributor/kind/action/save',
                        destroy:  SITEURL+'distributor/kind/action/delete'
                    },
                    reader:{
                        type:'json',
                        root:'children'
    ...
    function addSub(pid,path) {
        ...
        Ext.Ajax.request({
            method: 'post',
            url: SITEURL+'distributor/kind/action/addsub',
    ...
    {console.log(ele,id,field,value,type,callback);
        ...
        Ext.Ajax.request({
            url   :  SITEURL+"distributor/kind/action/update",
            method  :  "POST",
            datatype  :  "JSON",
