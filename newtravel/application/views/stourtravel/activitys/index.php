...
<script>
        ...
        function () {
            ...
            window.attr_store = Ext.create('Ext.data.TreeStore', {
                ...
                proxy: {
                    type: 'ajax',
                    api: {
                        read: SITEURL + 'activitys/index/action/read/',  //读取数据的URL
                        update: SITEURL + 'activitys/index/action/save/',
                        destroy: SITEURL + 'activitys/index/action/delete/'
                    },
                    reader: 'json'
                },
                autoLoad: false,
            ...
            window.attr_treepanel = Ext.create('Ext.tree.Panel', {
                ...
                columns: [
                    ...
                    },
                    {
                        ...
                        text: '<span class="grid_column_text">活动名称</span>' ,
                    ...
                    },
                    {
                        ...
                        renderer: function (value, metadata, record) {
                            ...
                            if (id&&id.indexOf('add')!=-1)
                                return '';
                            value=!value?'':value;
                          //  return "<input type='text' class='row-edit-txt' style='text-align:left'  onclick=\"ST.Util.prevPopup(event,this)\" onblur=\"updateField(this," + id + ",'rule',0,'input')\" value='" + value + "'/><br/>";
                            return "<a href ='javascript:' title='"+value+"'><input type='text' class='row-edit-txt' style='text-align:left'  onclick=\"ST.Util.prevPopup(event,this)\" onblur=\"updateField(this," + id + ",'rule',0,'input')\" value='" + value + "'/><br/></a>";
                        }

                    },
                    {
                        text: '<span class="grid_column_text">投票总数</span>',
                        dataIndex: 'help_num',
                        width: '5%',
                        draggable: false,
                        menuDisabled:true,
                        ...
                        renderer: function (value, metadata, record) {
                            ...
                            value=!value?'':value;
                            return "<input type='text' class='row-edit-txt' style='text-align:left' readonly='readonly' onclick=\"ST.Util.prevPopup(event,this)\" onblur=\"updateField(this," + id + ",'help_num',0,'input')\" value='" + value + "'/><br/>";
                        }

                    },
                    {
                        text: '<span class="grid_column_text">参与总数</span>',
                        dataIndex: 'part_num',
                        width: '5%',
                        draggable: false,
                        menuDisabled:true,
                    ...
                    {
                        text: '<span class="grid_column_text">浏览总数</span>',
                        dataIndex: 'show_num',
                        width: '5%',
                        draggable: false,
                        menuDisabled:true,
                        ...
                        renderer: function (value, metadata, record) {
                            ...
                            if (id&&id.indexOf('add')!=-1)
                                ...
                                return "<input type='text' class='row-edit-txt' style='text-align:left;' readonly='readonly' onclick=\"ST.Util.prevPopup(event,this)\" onblur=\"updateField(this," + id + ",'show_num',0,'input')\" value='" + value + "'/>";
                            //  return "<textarea class='row-edit-txt' style='text-align:left;height:80px;line-height:40px' onclick=\"ST.Util.prevPopup(event,this)\" onblur=\"updateField(this," + id + ",'activity_rule',0,'input')\" value='" + value + "'/><>";
                        ...
                        items: [
                            {
                                ...
                                handler: function (view, index, colindex, itm, e, record) {
                                    ...
                                    updateField(null, id, 'ishidden', newval);
                    ...
                    },
                    {
                        ...
                        renderer: function (value, metadata, record) {
                            ...
                            if (id.indexOf('add') != -1)
                                return '';
                            return '<a href=\"javascript:\" data-name=\"'+activity_name+'\" onclick=\"checkman(this,' + id +')\"  >查看活动人员</a>';
    ...
    function addSub(pid) {
        ...
        Ext.Ajax.request({
            method: 'post',
            url: SITEURL + 'activitys/index/action/addsub/',
            params: {pid: pid},
            success: function (response) {
    ...
    function updateField(ele, id, field, value, type) {
        ...
        Ext.Ajax.request({
            url: SITEURL + "activitys/index/action/update/",
            method: "POST",
            datatype: "JSON",
    ...
    function checkman(th,id){
       ...
       var url  = SITEURL + "activity/index/?actid="+id;
