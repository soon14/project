            ...
            <div class="frame-box">
                ...
                <div class="frame-con">
                    ...
                    <div class="verify-box">
                        ...
                        <form id="st_form" method="get" action="{$GLOBALS['cfg_basehost']}/newtravel/activity/share">
                            <input type="hidden" name = 'actid' value="{$acid}">

                            <div class="verify-list-tit"><strong class="bt">用户吸粉活动分享页面数据</strong></div>
                            ...
                            <div class="verify-con">
                                ...
                                <table class="verify-table" width="100%" border="0">
                                    ...
                                    <tr>
                                        ...
                                        <th width="15%" height="40" align="center" scope="col">分享的页面</th>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <div class="cp">
                                                ...
                                                <a href="/newtravel/activity/share?page={$page}&openid={$v['openid']}">
                                        ...
                                        <td><span class="price">{$v['share_page']}</span></td>

                                        <td><span class="num">{if $v['share_type']==1}朋友圈{else}好友{/if}</span></td>

                                        <td><span class="total">{$v['share_time']}</span></td>
                                    ...
                                    <tr name="tr1">
                                        ...
                                        <td colspan="8" align="right">
                                            <a href ="/newtravel/activity/share?page=1" class="page" style="margin-right: 8px">首页</a>
                                            <?php if($page!=1){?><a href="/newtravel/activity/share?page={$page-1}" class="page">上一页</a><span>...</span>
                                            <?php }
                                            if($page+10<=$totalPage){
                                                for($i=$page;$i<$page+10;$i++){
                                                    ?>
                                                    <a href="/newtravel/activity/share?page=<?php echo ($i);?>" style="border: 1px solid #666;padding: 0px 2.5px;margin: 10px 2.5px 0px 2.5px;" <?php if($page==$i){?>class="h3"<?php } ?>><?php echo $i;?></a>
                                                <?php }
                                            }
                                            else{
                                            ...
                                            if($page<$totalPage){?>
                                                <a href="/newtravel/activity/share?page={$page+1}" class="page">下一页</a><?php } ?>
                                            <a href ="/newtravel/activity/share?page={$totalPage}" class="page" style="margin-left: 8px;">尾页</a>
