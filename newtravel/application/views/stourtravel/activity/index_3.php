            ...
            <div class="frame-box">
                ...
                <div class="frame-con">
                    ...
                    <div class="verify-box">
                        ...
                        <div style="width: 120px;height: 15px;padding: 15px;margin-bottom: 15px;font-size: 15px;"><a href="/newtravel/activity/share?actid={$acid}" style="color: #FC6000">&rarr;分享数据</a></div>
                            ...
                            <div class="verify-con">
                                ...
                                <table class="verify-table" width="100%" border="0">
                                    ...
                                    <tr>
                                        ...
                                        <th width="10%" height="40" align="center" scope="col">游戏次数</th>

                                        <th width="13%" height="40" align="center" scope="col">最好成绩</th>

                                        <th width="8%" height="40" align="center" scope="col">领取奖品</th>
                                    ...
                                    <tr>
                                        ...
                                        <td><span class="num">{if $v['share_num']==0}未分享{else}{$v['share_num']}{/if}</span></td>

                                        <td><span class="total">{$v['play_num']}</span></td>
                                    ...
                                    <tr name="tr1">
                                        ...
                                        <td colspan="8" align="right">
                                            <a href ="/newtravel/activity/index?page=1&status={$get['status']}&paysource={$get['paysource']}" class="page" style="margin-right: 8px">首页</a>
                                            <?php if($page!=1){?><a href="/newtravel/activity/index?page={$page-1}&status={$get['status']}&paysource={$get['paysource']}" class="page">上一页</a><span>...</span>
                                            <?php }
                                            if($page+10<=$totalPage){
                                                for($i=$page;$i<$page+10;$i++){
                                                    ?>
                                                    <a href="/newtravel/activity/index?page=<?php echo ($i);?>&status={$get['status']}&paysource={$get['paysource']}" style="border: 1px solid #666;padding: 0px 2.5px;margin: 10px 2.5px 0px 2.5px;" <?php if($page==$i){?>class="h3"<?php } ?>><?php echo $i;?></a>
                                                <?php }
                                            }
                                            else{
                                            ...
                                            if($page<$totalPage){?>
                                                <a href="/newtravel/activity/index?page={$page+1}&status={$get['status']}&paysource={$get['paysource']}" class="page">下一页</a><?php } ?>
                                            <a href ="/newtravel/activity/index?page={$totalPage}&status={$get['status']}&paysource={$get['paysource']}" class="page" style="margin-left: 8px;">尾页</a>
    ...
    $(function(){
        ...
        $(".btn_excel").click(function(){
            ...
            var  istake    =  $(this).siblings('select[name=paysource]').val();
             //  alert(status+istake);
            var url = '/newtravel/activity/genexcel_3?istake='+istake+'&actid={$acid}';
