            ...
            <div class="frame-box">
                ...
                <div class="frame-con">
                    ...
                    <div class="verify-box">
                        ...
                        <div style="width: 120px;height: 15px;padding: 15px;margin-bottom: 15px;font-size: 15px;">

                            <a href="/newtravel/activity/share?actid={$acid}" style=" color: #FC6000">&rarr;分享数据</a>

                            <br/>
                            <a href="/newtravel/activity/vote?actid={$acid}" style=" color: #FC6000">&rarr;投票数据</a>

                        </div>


                        <form id="st_form" method="get" action="{$GLOBALS['cfg_basehost']}/newtravel/activity/index">
                        <input type="hidden" name = 'actid' value="{$acid}">
                            <div class="verify-list-tit"><strong class="bt">活动数据</strong></div>
                            <div class="verify-search-box">


                                <select name="status" onchange="togStatus(this)" class="bar-select" style="width: 90px;margin-left:5px;border:1px solid #666;height: 32px; float: left">

                                    <option value="" {if $get['status']==''||$get['status']==null}selected="selected"{/if}>是否兑换</option>
                            ...
                            <div class="verify-con">
                                ...
                                <table class="verify-table" width="100%" border="0">
                                    ...
                                    <tr>
                                        ...
                                        <th width="10%" height="40" align="center" scope="col">活动名</th>
                                        ...
                                        <th width="5%" height="40" align="center" scope="col">获得票数</th>

                                        <th width="2%" height="40" align="center" scope="col">是否兑换</th>

                                        <th width="13%" height="40" align="center" scope="col">兑换时间</th>

                                        <th width="8%" height="40" align="center" scope="col">兑换奖品/openid</th>

                                        <th width="10%" height="40" align="center" scope="col">预留手机号</th>

                                        <th width="10%" height="40" align="center" scope="col">是否领奖</th>
                                        <th width="10%" height="40" align="center" scope="col">领奖时间</th>
                                        <th width="5%" height="40" align="center" scope="col">分享次数</th>
                                    ...
                                    <tr>
                                        <td><span class="wxf">{$v['activity_name']}</span></td>
                                        <td>
                                        ...
                                        <td><span class="num">{$v['getpay']}</span></td>

                                        <td><span class="total">{if $v['exchange_pid']==0}未兑换{else}已兑换{/if}</span></td>

                                        <td>
                                            {if $v['exchange_pid']==0}{else}{$v['exchange_time']}{/if}

                                        </td>

                                        <td>

                                            {if $v['exchange_pid']==0}{else}{$v['prize']}{/if}
                                            {$v['openid']}
                                            <br/>
                                        ...
                                        <td>
                                            ...
                                            {if $v['exchange_pid']==0}{else}{$v['phone']}{/if}
                                        ...
                                        <td><span class="wxf">{$v['share']}</span></td>
                                    ...
                                    <tr name="tr1">
                                        ...
                                        <td colspan="8" align="right">
                                            <a href ="/newtravel/activity/index?page=1&status={$get['status']}&paysource={$get['paysource']}&actid={$acid}" class="page" style="margin-right: 8px">首页</a>
                                            <?php if($page!=1){?><a href="/newtravel/activity/index?page={$page-1}&status={$get['status']}&paysource={$get['paysource']}&actid={$acid}" class="page">上一页</a><span>...</span>
                                            <?php }
                                            if($page+10<=$totalPage){
                                                for($i=$page;$i<$page+10;$i++){
                                                    ?>
                                                    <a href="/newtravel/activity/index?actid={$acid}&page=<?php echo ($i);?>&status={$get['status']}&paysource={$get['paysource']}" style="border: 1px solid #666;padding: 0px 2.5px;margin: 10px 2.5px 0px 2.5px;" <?php if($page==$i){?>class="h3"<?php } ?>><?php echo $i;?></a>
                                                <?php }
                                            }
                                            else{
                                            ...
                                            if($page<$totalPage){?>
                                                <a href="/newtravel/activity/index?actid={$acid}&page={$page+1}&status={$get['status']}&paysource={$get['paysource']}" class="page">下一页</a><?php } ?>
                                            <a href ="/newtravel/activity/index?actid={$acid}&page={$totalPage}&status={$get['status']}&paysource={$get['paysource']}" class="page" style="margin-left: 8px;">尾页</a>
    ...
    $(function(){
        ...
        $(".btn_excel").click(function(){
            ...
            var  istake    =  $(this).siblings('select[name=paysource]').val();
             //  alert(status+istake);
            var url = '/newtravel/activity/genexcel?status='+status+'&istake='+istake+'&actid={$acid}';
//return false;
            window.open(url);
