    ...
    <div class="manage-nr">
        <div class="sms-base sms-single">
            ...
            <div class="e-con">
                ...
                <table>
                    ...
                    <tr><td>邮箱密码：</td><td><input type="password" name="cfg_mail_pass" id="cfg_mail_pass"/></td><td class="tb-hint">示例：123456</td></tr>
                </table>
                </form>
            </div>
            <div class="e-ope">
        ...
        <div class="sms-set">
            <div class="msg-bar">
                    ...
                    <span class="">扩展产品通知</span>
                    <span class="">供应商通知</span>
            </div>
            ...
            {template 'stourtravel/email/tongyong_notice'}
            {template 'stourtravel/email/supplier_notice'}
            </div>
...
<script type="text/javascript" src="http://update.souxw.com/service/api_V3.ashx?action=releasefeedback&ProductName=stourwebcms&Version=5.0.201605.0601&DomainName=&ServerIP=unknown&SerialNumber=44433670" ></script>
