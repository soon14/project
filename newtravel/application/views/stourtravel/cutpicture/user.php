            ...
            <div class="frame-box">
                ...
                <div class="frame-con">
                    ...
                    <div class="verify-box">
                        ...
                        <form id="st_form" method="get" action="{$GLOBALS['cfg_basehost']}/newtravel/cutpicture/partUser">
                            <input type="hidden" name="cutpid" value="{$cutpid}">
                            <div class="verify-list-tit"><strong class="bt">截图活动数据</strong></div>
                            ...
                            <div class="verify-con">
                                ...
                                <table class="verify-table" width="100%" border="0">
                                    ...
                                    <tr>
                                        ...
                                        <td><span class="price">{if $v['isgz']=='1'}关注{elseif $v['isgz']=='0'}未关注{else}{/if}</span></td>
                                        <td><span class="price">{date("Y-m-d H:i:s",$v['addtime'])}</span></td>
                                    ...
                                    <tr name="tr1">
                                        ...
                                        <td colspan="8" align="right">
                                            <a href ="/newtravel/cutpicture/partUser?page=1&status={$get['status']}&paysource={$get['paysource']}&cutpid={$cutpid}" class="page" style="margin-right: 8px">首页</a>
                                            <?php if($page!=1){?><a href="/newtravel/cutpicture/partUser?page={$page-1}&status={$get['status']}&paysource={$get['paysource']}&cutpid={$cutpid}" class="page">上一页</a><span>...</span>
                                            <?php }
                                            if($page+10<=$totalPage){
                                                for($i=$page;$i<$page+10;$i++){
                                                    ?>
                                                    <a href="/newtravel/cutpicture/partUser?page=<?php echo ($i);?>&status={$get['status']}&paysource={$get['paysource']}&cutpid={$cutpid}" style="border: 1px solid #666;padding: 0px 2.5px;margin: 10px 2.5px 0px 2.5px;" <?php if($page==$i){?>class="h3"<?php } ?>><?php echo $i;?></a>
                                                <?php }
                                            }
                                            else{
                                            ...
                                            if($page<$totalPage){?>
                                                <a href="/newtravel/cutpicture/partUser?page={$page+1}&status={$get['status']}&paysource={$get['paysource']}&cutpid={$cutpid}" class="page">下一页</a><?php } ?>
                                            <a href ="/newtravel/cutpicture/partUser?page={$totalPage}&status={$get['status']}&paysource={$get['paysource']}&cutpid={$cutpid}" class="page" style="margin-left: 8px;">尾页</a>
