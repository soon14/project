                    ...
                    <div id="content_basic" class="product-add-div content-show">
                        ...
                        <div class="add-class">
                            ...
                            <dl>
                                <dt>自驾目的地：</dt>
                                <dd>
                                    <input type="text" name="self_driving_mdd" id="self_driving_mdd" value="{$info['selfDriMdd']}">
...
<!--                                    <label>-->
<!---->
<!--                                        <input class="fl mt-8 mr-3" type="radio" name="multi_period"  {if $info['multi_period']==0}checked="checked"{/if} value="0">-->
<!---->
<!--                                        <span class="fl mr-20">单期</span>-->
<!---->
<!--                                    </label>-->
<!---->
<!--                                    <label>-->
<!---->
<!--                                        <input class="fl mt-8 mr-3" type="radio" name="multi_period"  {if $info['multi_period']==1}checked="checked"{/if} value="1">-->
<!---->
<!--                                        <span>多期</span>-->
...
<!--                            </dl>-->
                            <dl>
                                <dt>出团日期：</dt>
                                <dd>
                                    <input type="date" name="time" class="time_c" value="{$info['linedate']}" >
                    ...
                    <div id="content_distributor" class="product-add-div content-hide">
                        ...
                        <div class="add-class">
                            ...
                            <dl>
                             ...
                             <!--------获取 分销商家------>
                            {if !empty($info['id'])}
                             {php $firm_dis=Common::getDistributor(1,$info['id']);}
                            ...
                            {if !empty($info['id'])}
                            {php $p_dis=Common::getDistributor(1,$info['id'],2);}
    ...
    <script>
        ...
        function delImg_luoji(th,lineid,k){
            ...
            var  url = "/newtravel/line/delimg_luoji";
            $.ajax({
                  type:"post",
                  url :url,
