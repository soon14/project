               ...
               },
			   {
				   ...
				   renderer : function(value, metadata,record) {
					  //  return  "<input type='checkbox' class='product_check' value='"+value+"'/>"; 
									 ...
									 if(!isNaN(id))
			                           return "<a href='"+url+"' class='line-title' target='_blank' >"+value+"&nbsp;&nbsp;"+iconname+"</a>&nbsp;&nbsp;&nbsp;<a href='javascript:' data-title='"+value+"' onclick='humanCount("+aid+")' class='suit-title' style='float:right'>&bull;&nbsp;&nbsp;人员统计</a><a href='javascript:' data-title='"+value+"' onclick='checkorder(this)' class='suit-title' style='float:right'>&bull;&nbsp;&nbsp;查看订单</a>";
...
//			   },
  ...
  function create_order(id){
        ...
        var url = SITEURL +"/line/create_order/parentkey/product/itemid/1?lineid="+id;
   ...
   {
       CHOOSE.setSome("人员统计",{maxHeight:500},SITEURL+'line/humanCount?lineaid='+aid,true);
   }
