                                  ...
                                  <div class="price_sub">
                                      <div>
                                          <table class="price_tb">
                                              ...
                                              <tr>
                                                 <td class="tit">库存：</td><td><input type="hidden"  class="set-text-xh text_100 mt-2" name="number" value="-1"> <!--<span style="color:gray;padding-left:10px">-1表示不限</span>--></td>
                                              </tr>
                                          </table>
    ...
    function showMore()
    {
     ...
     function clearMore()
     {
         ...
         var productid = $("#spotid").val();
            ...
            $.ajax({
                type: 'POST',
                url: SITEURL+"spot/clearMore",
                data: {suitid:ticketid,productid:productid},
