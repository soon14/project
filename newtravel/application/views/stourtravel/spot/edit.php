            ...
            <form method="post" name="product_frm" id="product_frm">
                ...
                <div class="manage-nr">
                    ...
                    <div class="w-set-tit bom-arrow" id="nav">
                        ...
                        <span data-id="distributor"><s></s>分销商设置</span>
                        ...
                        <div class="add-class">
                            ...
                            <dl>
                                ...
                                <dd>
                                    ...
                                    <span style="color: #666;font-size: 11px;">&nbsp;&nbsp;&nbsp;&nbsp;*推荐后会在前台首页和前台景点首页显示</span>
                    ...
                    <div class="product-add-div" data-id="distributor">
                        ...
                        <div class="add-class">
                            ...
                            <!--------获取 分销商家------>
                            {if !empty($info['id'])}
                            {php $firm_dis=Common::getDistributor(5,$info['id']);}
                            ...
                            {if !empty($info['id'])}
                            {php $p_dis=Common::getDistributor(5,$info['id'],2);}
