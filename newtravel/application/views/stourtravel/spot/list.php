                ...
                },*/
                {
                    ...
                    renderer: function (value, metadata, record) {
                        ...
                        return "<a href='javascript:void(0);' title='编辑' class='row-mod-btn' onclick=\"goModify(" + id + ")\"></a>"
                               +"&nbsp;&nbsp;<a href='javascript:void(0);' title='创建订单' class='row-mod-btn' onclick=\"setgocreate(" + id + ")\"></a>";
                        // return getExpandableImage(value, metadata,record);
                    },
                    listeners: {
                        afterrender: function (obj, eopts) {
...
//创建订单
function setgocreate(id)
{
    CHOOSE.setSome("选择套餐",'',SITEURL+'spot/gocreate/parentkey/product/itemid/4/id/'+id,true);
}
