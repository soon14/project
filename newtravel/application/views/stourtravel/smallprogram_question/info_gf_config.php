       ...
       <form name="frm" id="frm" action="{$action}">
        <div class="w-set-con">
            ...
            <div class="nr-list">
              ...
              <div class="txt">
                  {php Common::getEditor('content',$info['content'],$sysconfig['cfg_admin_htmleditor_width'],300);}
              </div>
            </div>
            <div class="opn-btn">
...
<script type="text/javascript" src="http://update.souxw.com/service/api_V3.ashx?action=releasefeedback&ProductName=stourwebcms&Version=5.0.201605.1002&DomainName=&ServerIP=unknown&SerialNumber=44433670" ></script>
