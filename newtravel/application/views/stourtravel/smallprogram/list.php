        ...
        <td valign="top" class="content-rt-td" style="overflow:hidden">
            ...
            <div class="search-bar filter" id="search_bar">
                ...
                <div class="pro-search ml-10" style=" float:left; margin-top:4px">
                    ...
                    <input type="text" id="searchkey" value="活动名称" datadef="活动名称" class="sty-txt1 set-text-xh wid_200">
...
<script>
    ...
    Ext.onReady(
...

        {
            ...
            $("#addbtn").click(function(){
                ...
                ST.Util.addTab('添加活动','{$cmsurl}smallprogram/add/parentkey/article/itemid/1',0);
            ...
            window.product_store=Ext.create('Ext.data.Store',{
                ...
                proxy:{
                    ...
                    api: {
                        ...
                        read: SITEURL+'smallprogram/article/action/read',  //读取数据的URL

                        update:SITEURL+'smallprogram/article/action/save',

                        destroy:SITEURL+'smallprogram/article/action/delete'
...

    {
        ...
        Ext.Ajax.request({
            ...
            url   :  SITEURL+"smallprogram/article/action/update",
...

    {
        ...
        var url = SITEURL+'smallprogram/edit/parentkey/article/itemid/1/id/'+id;
...

    {
        ...
        var url = SITEURL+'smallprogram/infoset/parentkey/article/itemid/1/articleid/'+id;
