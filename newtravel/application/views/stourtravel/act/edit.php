...
<!--                            </dl>-->
                            <dl>
                                <dt>活动日期：</dt>
                                <dd>
                                    <input type="date" name="time" class="time_c" data-required="true" value="{$info['linedate']}" >~ <input type="date" name="timeover" data-required="true" class="time_c" value="{$info['timeover']}" >
                        ...
                        <div class="up-pic">
                            ...
                            <dl>
                                ...
                                <dd>
                                    ...
                                    <span class="tip-img-size">&nbsp;&nbsp;&nbsp;&nbsp;建议上传尺寸（待定）</span>
                            ...
                            <dl>
                                ...
                                <dd>
                                    <div class="up-file-div">
                                        ...
                                        <div id="pic_btn2" class="btn-file mt-4">上传图片</div>

                                    </div>

                                    <div class="up-list-div2">
                                        ...
                                        <ul>
                                            ...
                                            $pic_arr1 = explode(',', $info['piclist1']);

                                            $img_index = 1;

                                            $head_index = 0;

                                            foreach ($pic_arr1 as $k => $v) {
                                                ...
                                                $html .= '<input type="text" class="img-name" name="images1title[' . $img_index . ']" value="' . $imginfo_arr[1] . '" style="width:90px">';

                                                $html .= '<input type="hidden" class="img-path" name="images1[' . $img_index . ']" value="' . $imginfo_arr[0] . '">';
                                                ...
                                                //  $html.='<span class="btn-ste" onclick="Imageup.setHead(this,' . $img_index . ')" ' . $headpic_style . '>' . $headpic_hint . '</span><span class="btn-closed" onclick="Imageup.delImg(this,\'' . $imginfo_arr[0] . '\',' . $img_index . ')"></span>';
                                                $html.='<span class="btn-ste">' . $headpic_hint . '</span><span class="btn-closed" onclick="delImg_luoji(this,'.$info['id'].',\'' . $k. '\')"></span>';
                    ...
                    {php $contentArr=Common::getExtendContent(107,$extendinfo);}
    ...
    <script>
...

        {
            ...
            $.ajax({
                ...
                url:SITEURL+'act/ajax_del_dayspot',
    ...
    <script>
        ...
        $('#pic_btn2').click(function(){
            ...
            function Insert(result,bool){
                ...
                for(var i=0;i<len;i++){
                    ...
                    Imageup.genePic(temp[0],".up-list-div2 ul",".cover-div","images1");
        ...
        $("#linedoc-content").find('.del').live('click',function(){
            ...
            $.post(SITEURL+'act/ajax_del_doc/',{'file':parent.find('.path').val(),'id':id},function(rs){
        ...
        function delImg_luoji(th,lineid,k){
            ...
            var  url = "/newtravel/act/delimg_luoji";
            $.ajax({
                  type:"post",
                  url :url,
        ...
        function changePrice(th){
            ...
            var  url = "/newtravel/act/changePrice";
            $.ajax({
                type:"post",
                url :url,
