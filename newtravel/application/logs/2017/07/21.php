...
2017-07-21 10:47:21 --- ERROR: Database_Exception [ 1054 ]: Unknown column 'pid' in 'where clause' [ SELECT `sline_cutpicture`.`id` AS `id`, `sline_cutpicture`.`activity_name` AS `activity_name`, `sline_cutpicture`.`activity_link` AS `activity_link`, `sline_cutpicture`.`part_num` AS `part_num`, `sline_cutpicture`.`activity_rule` AS `activity_rule`, `sline_cutpicture`.`starttime` AS `starttime`, `sline_cutpicture`.`overtime` AS `overtime`, `sline_cutpicture`.`displayorder` AS `displayorder`, `sline_cutpicture`.`isopen` AS `isopen`, `sline_cutpicture`.`count` AS `count`, `sline_cutpicture`.`ResContent` AS `ResContent`, `sline_cutpicture`.`PhoneContent` AS `PhoneContent` FROM `sline_cutpicture` AS `sline_cutpicture` WHERE `pid` = '13' ] ~ MODPATH/database/classes/kohana/database/mysql.php [ 194 ]
2017-07-21 10:47:21 --- STRACE: Database_Exception [ 1054 ]: Unknown column 'pid' in 'where clause' [ SELECT `sline_cutpicture`.`id` AS `id`, `sline_cutpicture`.`activity_name` AS `activity_name`, `sline_cutpicture`.`activity_link` AS `activity_link`, `sline_cutpicture`.`part_num` AS `part_num`, `sline_cutpicture`.`activity_rule` AS `activity_rule`, `sline_cutpicture`.`starttime` AS `starttime`, `sline_cutpicture`.`overtime` AS `overtime`, `sline_cutpicture`.`displayorder` AS `displayorder`, `sline_cutpicture`.`isopen` AS `isopen`, `sline_cutpicture`.`count` AS `count`, `sline_cutpicture`.`ResContent` AS `ResContent`, `sline_cutpicture`.`PhoneContent` AS `PhoneContent` FROM `sline_cutpicture` AS `sline_cutpicture` WHERE `pid` = '13' ] ~ MODPATH/database/classes/kohana/database/mysql.php [ 194 ]
--
