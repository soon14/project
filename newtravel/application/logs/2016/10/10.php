...
2016-10-10 11:56:45 --- ERROR: Database_Exception [ 1064 ]: You have an error in your SQL syntax; check the manual that corresponds to your MySQL server version for the right syntax to use near 'as title from sline_ where id='175'' at line 1 [ select aid,webid, as title from sline_ where id='175' ] ~ MODPATH/database/classes/kohana/database/mysql.php [ 194 ]
2016-10-10 11:56:45 --- STRACE: Database_Exception [ 1064 ]: You have an error in your SQL syntax; check the manual that corresponds to your MySQL server version for the right syntax to use near 'as title from sline_ where id='175'' at line 1 [ select aid,webid, as title from sline_ where id='175' ] ~ MODPATH/database/classes/kohana/database/mysql.php [ 194 ]
--
